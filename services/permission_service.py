...
from repositories.permission_repository import (
    get_allowed_roles_for_creator as repository_get_allowed_roles_for_creator,
    can_user_create_role as repository_can_user_create_role,
    get_all_roles as repository_get_all_roles,
)


def get_allowed_roles_for_creator(user):
    """Return list of roles that the user is allowed to create."""
    return repository_get_allowed_roles_for_creator(user)


def can_user_create_role(user, role):
    """Check if the user is allowed to create the given role."""
    return repository_can_user_create_role(user, role)


def get_all_roles():
    """Return list of all possible roles."""
    return repository_get_all_roles()
