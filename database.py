...
def _create_tables(connection, backend):
    ...
    for query in [
        ...
        CREATE TABLE IF NOT EXISTS customers (
            ...
            phone TEXT,
            email TEXT,
            accepts_whatsapp {integer_boolean} DEFAULT 1,
            accepts_sms {integer_boolean} DEFAULT 1,
            metadata_json TEXT,
            created_at TEXT,
            updated_at TEXT
        )
...
def _ensure_columns(connection, backend):
    desired_columns = {
        ...
        "customers": {
            ...
            "phone": "TEXT",
            "email": "TEXT",
            "accepts_whatsapp": "BOOLEAN DEFAULT 1" if backend == "postgres" else "INTEGER DEFAULT 1",
            "accepts_sms": "BOOLEAN DEFAULT 1" if backend == "postgres" else "INTEGER DEFAULT 1",
            "metadata_json": "TEXT",
            "created_at": "TEXT",
            "updated_at": "TEXT",
        },
